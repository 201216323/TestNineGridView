...
public class ImagePreviewActivity extends Activity implements ViewTreeObserver.OnPreDrawListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_SaveImage = (TextView) findViewById(R.id.tv_SaveImage);
        ...
        viewPager.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                tv_pager.setText(String.format(getString(R.string.select), String.valueOf(currentItem + 1), "" + imageInfo.size()));
            }
        });
        tv_pager.setText(String.format(getString(R.string.select), String.valueOf(currentItem + 1), "" + imageInfo.size()));
        tv_SaveImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(ImagePreviewActivity.this, "currentItem；" + currentItem, Toast.LENGTH_SHORT).show();
            }
        });
    }
